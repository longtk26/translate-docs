#!/bin/bash
# Production Backend User Data Script
...
cat > /opt/aws/amazon-cloudwatch-agent/etc/config.json << 'EOF'
{
        ...
        "collect_list": [
          {
            ...
            "log_group_name": "/aws/ec2/backend-prod",
            "log_stream_name": "{instance_id}/messages"
          },
          {
            "file_path": "/opt/translate-docs/backend/logs/*.log",
            "log_group_name": "/aws/ec2/backend-prod",
  ...
  "metrics": {
    "namespace": "TranslateDocs/Backend",
    "metrics_collected": {
      "cpu": {
        "measurement": [
          {
...
echo "Production backend instance initialized successfully"
